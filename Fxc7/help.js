...
│🈳 *${prefix}tahta TIO SAAD*
│🈳 *${prefix}croman TIO SAAD dan BOT*
│🈳 *${prefix}clove TIO SAAD*
│🈳 *${prefix}cparty TIO SAAD*
│🈳 *${prefix}csky TIO SAAD*
│🈳 *${prefix}tts id Haii*
│🈳 *${prefix}ttp TIO SAAD [ERRO]*
│🈳 *${prefix}cballon TIO SAAD*
│🈳 *${prefix}cpaper TIO SAAD*
│🈳 *${prefix}slide TIO SAAD BOT WA*
│🈳 *${prefix}stiker*
│🈳 *${prefix}gifstiker*
│🈳 *${prefix}toimg*
│🈳 *${prefix}img2url*
...
│🕹️ *${prefix}setpp*
│🕹️ *${prefix}infogc*
│🕹️ *${prefix}add 55𝑋𝑋𝑋𝑋𝑋𝑋*
│🕹️ *${prefix}kick @𝑚𝑎𝑟𝑞𝑢𝑒 𝑜 𝑓𝑑𝑝*
│🕹️ *${prefix}kicktime @𝑚𝑎𝑟𝑞𝑢𝑒 𝑜 𝑓𝑑𝑝*
│🕹️ *${prefix}promote @𝑚𝑎𝑟𝑞𝑢𝑒 𝑜 𝑓𝑑𝑝*
│🕹️ *${prefix}demote @𝑚𝑎𝑟𝑞𝑢𝑒 𝑜 𝑓𝑑𝑝*
│🕹️ *${prefix}setname*
│🕹️ *${prefix}setdesc*
│🕹️ *${prefix}linkgrup*
│🕹️ *${prefix}tagme*
...
│✝️ *${prefix}pasangan Farhan/Iriene*
│✝️ *${prefix}gantengcek Farhan*
│✝️ *${prefix}cantikcek Iriene*
│✝️ *${prefix}artinama Farhan*
│✝️ *${prefix}persengay Topan*
│✝️ *${prefix}pbucin Farhan*
│✝️ *${prefix}bpfont Farhan*
│✝️ *${prefix}textstyle FXC7*
